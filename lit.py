...
file_path = 'D:/Finallll/Disease-Detection-based-on-Symptoms-master (3)/Disease-Detection-based-on-Symptoms-master/classifier.pkl'
...
df_comb = pd.read_csv("D:/Finallll/Disease-Detection-based-on-Symptoms-master (3)/Disease-Detection-based-on-Symptoms-master/Dataset/dis_sym_dataset_comb.csv")
df_norm = pd.read_csv("D:/Finallll/Disease-Detection-based-on-Symptoms-master (3)/Disease-Detection-based-on-Symptoms-master/Dataset/dis_sym_dataset_norm.csv") # Individual Disease
